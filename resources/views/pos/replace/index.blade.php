...
<div class="replace">
    <div class="container">
        <div class="row">
            <div class="col">
                <h2 class="mb-25"><a href="{{route('replace.index')}}">Replace Product</a> 
        ...
        <div class="row">
            <div class="col"></div>
           <div class="col">
                <form class="form-inline" action="{{route('replace.search')}}" method="get">
                ...
                @foreach($replaces as $replace)
                    <tr>
                        ...
                        <a class="svgimg" href="{{route('replace.edit',$replace->id)}}">
                                            ...
                                            <form method="POST" id="delete-form-{{$replace->id}}" 
                                                    action="{{route('replace.delete',$replace->id)}}" style="display: none;">
                                                    @csrf
                                                    {{method_field('delete')}}
                                                ...
                                                document.getElementById('delete-form-{{$replace->id}}').submit();
                                                }else{
                                                event.preventDefault();
                                                }
                                                "class="btn" href="">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="replaceModalLabel">Replace Add</h5>
