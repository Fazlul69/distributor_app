...
@section('content')
    <div class="container damage">
        <div class="row">
            <div class="col"><a href="{{route('damage.index')}}">Damage Product List</a></div>
            <div class="col">
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#damageModal">+ Add Damage</button>
            </div>
        </div>
        <div class="row">
               <div class="col"></div>
