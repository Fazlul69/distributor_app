...
@section('content')
    <div class="product_in">
        <div class="container">
            <p><a href="{{ route('dashboard.view') }}">Dashboard</a> / <a href="{{ route('productin') }}">Purchase Invoice</a>
            </p>
            <a href="{{ route('productin.create') }}" class="add">+ Add Invoice</a>
            <div class="row">
                <div class="col">
                    <form class="form-inline search justify-content-center" action="{{ route('pinput.invoice.search') }}"
                        method="get">
                        <div class="row">
                            <div class="col"><input class="form-control mr-sm-2" name="query" type="text"
                                    placeholder="Invoice No" aria-label="Search"></div>
                        </div>
                        <button class="btn btn-outline-success my-2 my-sm-0" type="submit"><svg
                ...
                <div class="col">
                    <form class="form-inline search justify-content-center" action="{{ route('pinput.datesearch') }}"
                        method="get">
                        <div class="row">
                            <div class="col"><input class="form-control mr-sm-2" name="query" type="date"
            ...
            <div class="">
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($productinputs->unique('invoice') as $productinput)
                                <tr>
                                    ...
                                    <td>
                                        <a class="svgimg" href="{{ route('pinput.edit', $productinput->id) }}">
                                        ...
                                        <a class="" href="{{ route('pinput.show', $productinput->invoice) }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <form method="POST" id="delete-form-{{ $productinput->id }}"
                                            action="{{ route('pinput.delete', $productinput->id) }}" style="display: none;">
                                            @csrf
                                            {{ method_field('delete') }}
                                        ...
                                        document.getElementById('delete-form-{{ $productinput->id }}').submit();
                                        }else{
                                        event.preventDefault();
                                        }
                                        "class="btn"
