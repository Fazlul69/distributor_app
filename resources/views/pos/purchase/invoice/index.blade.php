...
@section('content')
   <div class="product_in">
       <div class="container">
       <p><a href="{{route('dashboard.view')}}">Dashboard</a> / <a href="{{route('productin')}}">Purchase Invoice</a></p>
           <a href="{{route('productin.create')}}" class="add">+ Add Invoice</a>
           <div class="row">
               <div class="col">
                    <form class="form-inline search justify-content-center" action="{{route('pinput.invoice.search')}}" method="get">
                        <div class="row">
               ...
               <div class="col">
                    <form class="form-inline search justify-content-center" action="{{route('pinput.datesearch')}}" method="get">
                        <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a class="svgimg" href="{{route('pinput.edit',$productinput->id)}}">
                                    ...
                                    <form method="POST" id="delete-form-{{$productinput->id}}" action="{{route('pinput.delete',$productinput->id)}}" style="display: none;">
                                        @csrf
                                        {{method_field('delete')}}
