...
@section('content')
    <div class="items">
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    <form class="form-inline search justify-content-center" action="{{ route('items.search') }}"
                        method="get">
                        <div class="row">
                            <div class="col"><input class="form-control mr-sm-2" name="query" type="text"
                                    placeholder="Product Name" aria-label="Search"></div>
                        </div>
                    ...
                    <form action="{{ route('item.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="dp" name="buy_price">
                            </div>
                            <div class="col">
                                <label for="tp" class="form-label">Sell Price</label>
                                <input type="text" class="form-control" id="tp" name="sell_price">
                            </div>
                            <div class="col">
