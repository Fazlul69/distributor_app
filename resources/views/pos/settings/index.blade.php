                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="mobile_1" id=""
                                    placeholder="First Mobile No.">
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Mobile 2</label>
                                <input type="text" class="form-control" name="mobile_2" id=""
                                    placeholder="Second Mobile No.">
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Facebook Link</label>
                                <input type="text" class="form-control" name="facebook_link" id=""
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" name="email_1" id=""
                                    placeholder="First Email">
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Email 2</label>
                                <input type="email" class="form-control" name="email_2" id=""
                                    placeholder="Second Email">
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Whatsapp Link</label>
                                <input type="text" class="form-control" name="whatsapp_link" id=""
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                {{-- <div class="mb-3">
                                    ...
                                    <img src="{{ asset('details/' . $detail->website_logo) }}" class="rounded"
                                ...
                                <div class="mb-3">
                                    <label for="" class="form-label">Company Name</label>
                                    <input type="text" class="form-control" name="company_name" id=""
                                        placeholder="Company Name" value="{{ $detail->company_name }}">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Address</label>
                                    <input type="text" class="form-control" name="address" id=""
                                        placeholder="Address" value="{{ $detail->address }}">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Mobile 1</label>
                                    <input type="text" class="form-control" name="mobile_1" id=""
                                        placeholder="First Mobile No." value="{{ $detail->mobile_1 }}">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Mobile 2</label>
                                    <input type="text" class="form-control" name="mobile_2" id=""
                                        placeholder="Second Mobile No." value="{{ $detail->mobile_2 }}">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Facebook Link</label>
                                    <input type="text" class="form-control" name="facebook_link" id=""
                                        placeholder="Facebook Link" value="{{ $detail->facebook_link }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="" class="form-label">Company Logo</label>
                                    <img src="{{ asset('details/' . $detail->dashboard_logo) }}" class="rounded"
                                        alt="Logo" width="60px" height="60px">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Company Logo</label>
                                ...
                                {{-- <div class="mb-3">
                                    ...
                                    <img src="{{ asset('details/' . $detail->login_logo) }}" class="rounded"
                                        alt="Logo" width="60px" height="60px">
                                </div> --}}
                                {{-- <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="" class="form-label">Email 1</label>
                                    <input type="email" class="form-control" name="email_1" id=""
                                        placeholder="First Email" value="{{ $detail->email_1 }}">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Email 2</label>
                                    <input type="email" class="form-control" name="email_2" id=""
                                        placeholder="Second Email" value="{{ $detail->email_2 }}">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Whatsapp Link</label>
                                    <input type="text" class="form-control" name="whatsapp_link" id=""
                                        placeholder="Whatsapp Link" value="{{ $detail->whatsapp_link }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
