...
@section('content')
    ...
    <div class="invoice_create">
        <div class="container">
        <p><a href="{{route('dashboard.view')}}">Dashboard</a> / <a href="{{route('ecom_invoice.index')}}">Sales Invoice</a></p>
            <div class="card">
                <div class="card-body">
                    <form action="{{route('ecom_invoice.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                        <div class="col invoice_table">
                            <div class="row section_one">
                                ...
                                <div class="col">
                                    <label for="bill" class="form-label">Bill to</label>
                                    <input type="text" class="form-control" name="customer_mobile[]" placeholder="Customer No.">
                                </div>
                                <div class="col">
                                    @php
                                        $heee = DB::table('ecomsales')->latest('id')->first();
                                    @endphp
                            ...
                            <div class="row add tr">
                                <div class="col">
                                    <select class="form-control ecomCategory" name="category_id[]">
                                        <option value="">Category</option>
                                        @foreach($ecomcategories as $ecc)
                                        <option value="{{$ecc->id}}">{{$ecc->category_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col">
                                    <select class="form-control ecomSubCategory" name="subcategory[]">
                                        <option value="">SubCategory</option>
                                    </select>
                                </div>
                                <div class="col">
                                    <select class="form-control ecomproductName" name="product_id[]">
                                        <option value="">Item</option>
                                    </select>
                                </div>
                                <div class="col hide">
                                    <input type="text" class="form-control ecom_quality" name="purchase_quality" placeholder="from purchase">
                                </div>
                                <div class="col hide">
                                    <input type="text" class="form-control ecomsalesquality" name="sales_quality" placeholder="from sale">
                                </div>
                                <div class="col">
                                    <input type="text" class="form-control ecom_stock" placeholder="Stock">
                                </div>
                                <div class="col">
                                    <input type="text" class="form-control ecomSalePrice" id="sell_price" name="sell_price[]" placeholder="Sell Price">
                                </div>
                                <div class="col">
